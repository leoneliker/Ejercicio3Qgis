...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-2021697.447200, 3203383.615978, 481766.788042, 5433368.463398],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-3505247.202240, 1741189.971941, 2788632.484781, 6427457.488440], map.getSize());
    ...
    element: (() => {
        ...
        if (17 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Visor de practica';
            }
